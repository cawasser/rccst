(ns bh.rccst.views.atom.example.chart.colored-pie-chart.data-ratom-example
...
(log/info "bh.rccst.views.atom.example.chart.colored-pie-chart.data-ratom-example")
