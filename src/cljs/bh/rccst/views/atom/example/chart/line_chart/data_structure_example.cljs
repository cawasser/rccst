(ns bh.rccst.views.atom.example.chart.line-chart.data-structure-example
...
(log/info "bh.rccst.views.atom.example.chart.line-chart.data-structure-example")


(defn example []
  (let [container-id "line-chart-2-data-structure-demo"
        component-id (utils/path->keyword container-id "line-chart-2")]
    [example/component-example
     :title "line Chart 2 (Live Data - structure)"
