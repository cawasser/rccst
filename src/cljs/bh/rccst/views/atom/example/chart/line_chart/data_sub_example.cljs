(ns bh.rccst.views.atom.example.chart.line-chart.data-sub-example
...
(defn example []
  (let [container-id :line-chart-2-data-sub-demo
        component-id (h/path->keyword container-id "line-chart-2")]

    [e/component-example
     :title "line Chart 2 (Live data - subscription)"
...
(comment
  (re-frame/subscribe [:line-chart-2-data-sub-demo])
  (re-frame/subscribe [:line-chart-2-data-sub-demo.blackboard])
  (re-frame/subscribe [:line-chart-2-data-sub-demo.blackboard.topic.sample-data])
  (re-frame/subscribe [:line-chart-2-data-sub-demo.blackboard.topic.sample-data.metadata])
  (re-frame/subscribe [:line-chart-2-data-sub-demo.blackboard.topic.sample-data.data])
...
(comment
  (def data [:line-chart-2-data-sub-demo :blackboard :topic.sample-data])
