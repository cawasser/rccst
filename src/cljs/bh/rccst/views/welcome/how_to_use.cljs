(ns bh.rccst.views.welcome.how-to-use
...
(defn overview []
  [o/overview
   ...
   are trying to solve many different kinds of problems. Specifically, we disguised this Catalog to support the needs of:
...
In some cases you can even play with configuration or data options, seeing how it responds. Each example also includes a snippet
...
functionality your client's need, without needing fo spend time an effort on extraneous details, like Servers, Databases, Deployment,
...
in their own solutions. In many cases, there are multiple options for a given Components. Sometimes they vary by the
source library they are drawn from (we re-package such components to make them interchangeable with minimal software code
changes). Sometimes they vary in how they work, with each option better suited to some specific situation. Having options
give you the freedom to choose what works best for you and your clients.
...
meaningful conversations with your Users and your Designers and Developers.
...
find it difficult to express their needs to technical people. Have a Catalog that everyone shares can help make it easier to
express you needs and desires in a concrete way, which the immediate feedback provided by everyone looking at the same visual
representation."])
