(ns bh.rccst.views.molecule.example.composite.simple-multi-chart
...
(log/info "bh.rccst.views.molecule.example.composite.simple-multi-chart")
...
> Current the data and config tools *DON'T WORK*
"
        [layout/frame
         ;;
