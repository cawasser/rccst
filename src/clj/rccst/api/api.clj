(ns rccst.api.api
  (:require [clojure.tools.logging :as log]
            ...
            [rccst.api.login :as login]
            [rccst.api.subscribe :as subscribe]
            [rccst.api.version :as version]
            [rccst.api.lookup :as lookup]))
...
(defn api
  ...
  - [version](/docs/api/rccst.api.verison.html)
  - [lookup](/docs/api/rccst.data-source.lookup.html)
    - ([schema](/docs/api/rccst.data-source.lookup.schema.html))
  - [login](/docs/api/rccst.api.login.html)
  - [subscribe](/docs/api/rccst.api.subscripbe.html)
