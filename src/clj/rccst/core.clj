(ns rccst.core
  (:require [clojure.tools.logging :as log]
            ...
            [rccst.components.data-sources :as data-sources]

            [rccst.components.database :as db]
            [rccst.components.pub-sub :as pub-sub]
            [rccst.components.repl :as repl]
            [rccst.components.system :as system]
            [rccst.components.webserver :as server]
            [rccst.components.websocket :as socket]
...
(defn new-system
  ...
  | :rccst.components.database-spec      | hash-map | database configuration information. Two are currently provided: |
